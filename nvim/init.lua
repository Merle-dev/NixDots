...
vim.opt.smartindent = false -- Smarter autoindentatin
...
vim.opt.updatetime = 125 -- Length of time to wait before triggering the plugin.
...
vim.opt.colorcolumn = "160" -- PEP8 like character limit vertical bar.
